...
namespace AsterNET
{
    ...
    public sealed class Logger
    {
        ...
        {
			string caller = debugInfo();
			Log.Debug("  Error 1: {0}", string.Concat(caller, " - ", o.ToString()));
        }
        ...
        public void Error(string msg)
        {
			...
			Log.Debug("  Error 2: {0}", string.Concat(caller, " - ", msg));
		}

        public void Error(string format, params object[] args)
        {
			string caller = debugInfo();
			Log.Debug("  Error 3: {0}", string.Concat(caller, " - ", string.Format(format, args)));
        ...
        {
			string caller = debugInfo();
			Log.Debug("  Error 4: {0}", string.Concat(caller, " - ", string.Format("{0}\n{1}", msg, ex)));
