...
{
	public class DispatchPulseContactIdModel : PageModel
	{
		...
		public IActionResult OnGet() {
			...
			Value = Contact.DPContactId == null ? null : Contact.DPContactId.ToString();
		...
		public IActionResult OnPost() {
			...
			Contact = Contact with {
				DPContactId = string.IsNullOrWhiteSpace(Value) ? null : Guid.Parse(Value),
			};
