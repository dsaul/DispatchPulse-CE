...
namespace API.Hubs
{
	public partial class APIHub : Hub
	{
		...
		public class PerformPBXRegisterDIDResponse : IdempotencyResponse
		{
		...
		public async Task PerformPBXRegisterDID(PerformPBXRegisterDIDParams p)
		{
			...
			do
			{
				...
				bool permAny = permissions.Contains(Databases.Konstants.kPermCRMPushDIDsAny);
				bool permCompany = permissions.Contains(Databases.Konstants.kPermCRMPushDIDsCompany);
