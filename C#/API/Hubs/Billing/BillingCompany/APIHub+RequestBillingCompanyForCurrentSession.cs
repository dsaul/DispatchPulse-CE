...
namespace API.Hubs
{
	public partial class APIHub : Hub
	{
		...
		public class RequestBillingCompanyResponse : PermissionsIdempotencyResponse
		{
		...
		public async Task RequestBillingCompanyForCurrentSession(RequestBillingCompanyForSessionParams p)
		{
			...
			do
			{
				...
				if (!permissions.Contains(EnvDatabases.kPermBillingCompaniesReadAny) &&
					!permissions.Contains(EnvDatabases.kPermBillingCompaniesReadCompany)
					)
				{
					response.IsError = true;
