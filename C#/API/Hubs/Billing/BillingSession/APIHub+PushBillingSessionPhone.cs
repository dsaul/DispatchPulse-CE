...
namespace API.Hubs
{
	...
	{
		public class PushBillingSessionPhoneParams : IdempotencyRequest
		{
			public Guid? SessionId { get; set; }
			public string? Phone { get; set; }
		}
		public class PushBillingSessionPhoneResponse : PermissionsIdempotencyResponse
		{
			public bool? Saved { get; set; } = false;
		}
		public async Task PushBillingSessionPhone(PushBillingSessionPhoneParams p)
		{
			if (p == null)
				return;

			PushBillingSessionPhoneResponse response = new PushBillingSessionPhoneResponse()
			{
			...
			do
			{
				...
				{
					response.IsError = true;
					response.ErrorMessage = "No phone provided.";
					break;
				}
			...
			await Clients.Caller.SendAsync(
				"PushBillingSessionPhoneCB", response).ConfigureAwait(false);
		}
	}
}
