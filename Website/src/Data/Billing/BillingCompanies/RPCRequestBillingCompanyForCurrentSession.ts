...
export type IRequestBillingCompanyForCurrentSessionPayload = IIdempotencyRequest
	...
	export interface IRequestBillingCompanyForCurrentSessionCB extends IIdempotencyResponse {
		billingCompany: IBillingCompanies;
	}
export class RPCRequestBillingCompanyForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingCompanyForCurrentSessionPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IRequestBillingCompanyForCurrentSessionCB): boolean {
