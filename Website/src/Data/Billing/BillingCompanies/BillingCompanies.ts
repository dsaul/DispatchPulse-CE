...
export class BillingCompanies {
	// RPC Methods
	public static RequestBillingCompanyForCurrentSession = 
		RPCMethod.Register<RPCRequestBillingCompanyForCurrentSession>(new RPCRequestBillingCompanyForCurrentSession());
	public static RequestCompanyNameInUse = 
		RPCMethod.Register<RPCRequestCompanyNameInUse>(new RPCRequestCompanyNameInUse());
	public static PerformCheckCompanyPhoneIdInUse = 
		RPCMethod.Register<RPCPerformCheckCompanyPhoneIdInUse>(new RPCPerformCheckCompanyPhoneIdInUse());
	public static PerformRegisterCreateDPDatabase = 
		RPCMethod.Register<RPCPerformRegisterCreateDPDatabase>(new RPCPerformRegisterCreateDPDatabase());
	public static PerformRegisterNewCompany = 
		RPCMethod.Register<RPCPerformRegisterNewCompany>(new RPCPerformRegisterNewCompany());
	public static PerformRegisterSaveServiceAgreement = 
		RPCMethod.Register<RPCPerformRegisterSaveServiceAgreement>(new RPCPerformRegisterSaveServiceAgreement());
	public static PerformUpdatePhoneId = 
		RPCMethod.Register<RPCPerformUpdatePhoneId>(new RPCPerformUpdatePhoneId());
	...
	public static GetMerged(mergeValues: Record<string, any>): IBillingCompanies {
	...
	public static All(): Record<string, IBillingCompanies> | null {
		const billingCompanies = store.state.Database.billingCompanies as Record<string, IBillingCompanies>;
	...
	public static CompanyForCurrentBillingContact(): IBillingCompanies | null {
		...
		if (!contact.companyId || IsNullOrEmpty(contact.companyId)) {
			console.error('!contact.companyId || IsNullOrEmpty(contact.companyId)');
			return null;
		}
