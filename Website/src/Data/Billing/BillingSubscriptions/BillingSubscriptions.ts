...
export class BillingSubscriptions {
	// RPC Methods
	public static RequestBillingSubscriptionsForCurrentSession = 
		RPCMethod.Register<RPCRequestBillingSubscriptionsForCurrentSession>(
			new RPCRequestBillingSubscriptionsForCurrentSession());
	
	public static GetMerged(mergeValues: Record<string, any>): IBillingSubscriptions {
	...
	public static ValidateObject(o: IBillingSubscriptions): IBillingSubscriptions {
