...
export interface IRequestBillingPackagesTypeForCurrentSessionCB extends IIdempotencyResponse {
	billingPackagesType: IBillingPackagesType[];
}

export class RPCRequestBillingPackagesTypeForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingPackagesTypeForCurrentSessionPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IRequestBillingPackagesTypeForCurrentSessionCB): boolean {
