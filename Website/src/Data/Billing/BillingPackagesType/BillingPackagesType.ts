...
export class BillingPackagesType {
	// RPC Methods
	public static RequestBillingPackagesTypeForCurrentSession = 
		RPCMethod.Register<RPCRequestBillingPackagesTypeForCurrentSession>(
			new RPCRequestBillingPackagesTypeForCurrentSession());
	
	public static GetMerged(mergeValues: Record<string, any>): IBillingPackagesType {
	...
	public static ValidateObject(o: IBillingPackagesType): IBillingPackagesType {
