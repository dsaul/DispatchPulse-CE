...
export type IRequestBillingContactsForCurrentSessionPayload = IIdempotencyRequest
	...
	export interface IRequestBillingContactsForCurrentSessionCB extends IIdempotencyResponse {
		billingContacts: IBillingContacts[];
	}

export class RPCRequestBillingContactsForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingContactsForCurrentSessionPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IRequestBillingContactsForCurrentSessionCB): boolean {
