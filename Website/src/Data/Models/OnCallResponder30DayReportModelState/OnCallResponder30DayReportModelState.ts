...
export interface IOnCallResponder30DayReportModelState {// tslint:disable-line
...
export class OnCallResponder30DayReportModelState {
	...
	public static GetMerged(mergeValues: Record<string, any>): IOnCallResponder30DayReportModelState {
