...
export class ProjectStatus {
	// RPC Methods
	public static RequestProjectStatus = RPCMethod.Register<RPCRequestProjectStatus>(new RPCRequestProjectStatus());
	public static DeleteProjectStatus = RPCMethod.Register<RPCDeleteProjectStatus>(new RPCDeleteProjectStatus());
	public static PushProjectStatus = RPCMethod.Register<RPCPushProjectStatus>(new RPCPushProjectStatus());
	...
	public static ForId(id: string | null): IProjectStatus | null {
		...
		const statuses = store.state.Database.projectStatus as Record<string, IProjectStatus>;
