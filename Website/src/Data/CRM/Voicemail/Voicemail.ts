...
export class Voicemail {
	// RPC Methods
	public static RequestVoicemails = 
		RPCMethod.Register<RPCRequestVoicemails>(new RPCRequestVoicemails());
	public static DeleteVoicemails = 
		RPCMethod.Register<RPCDeleteVoicemails>(new RPCDeleteVoicemails());
	public static PushVoicemails = 
		RPCMethod.Register<RPCPushVoicemails>(new RPCPushVoicemails());
	public static PerformGetVoicemailRecordingLink = 
		RPCMethod.Register<RPCPerformGetVoicemailRecordingLink>(new RPCPerformGetVoicemailRecordingLink());
	public static PerformVoicemailMarkAsHandled = 
		RPCMethod.Register<RPCPerformVoicemailMarkAsHandled>(new RPCPerformVoicemailMarkAsHandled());
	...
	public static ForId(id: string | null): IVoicemail | null {
		...
		const autoAttendants = store.state.Database.voicemails as { [id: string]: IVoicemail; };
	...
	public static DisplayNameForId(id: string | null): string | null {
		...
		if (!aa ||
			!aa.json ||
			!aa.json.messageLeftAtISO8601) {
			return null;
		}
		
		const dt = DateTime.fromISO(aa.json.messageLeftAtISO8601);
		
		return `${aa.json.callerIdNumber} at ${dt.toLocaleString(DateTime.DATETIME_MED)}`;
	}
