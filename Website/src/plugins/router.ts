		...
		
		{
			...
			meta: {
				...
				metaTags: [
					{
						name: 'description',
						content: 'Assignment Status Definitions - Dispatch Pulse',
					},
					{
						property: 'og:description',
						content: 'Assignment Status Definitions - Dispatch Pulse',
		...
		
		{
			...
			meta: {
				...
				metaTags: [
					{
						name: 'description',
						content: 'Employment Status Definitions - Dispatch Pulse',
					},
					{
						property: 'og:description',
						content: 'Employment Status Definitions - Dispatch Pulse',
		...
		
		{
			...
			meta: {
				...
				metaTags: [
					{
						name: 'description',
						content: 'Labour Non Billable Definitions - Dispatch Pulse',
					},
					{
						property: 'og:description',
						content: 'Labour Non Billable Definitions - Dispatch Pulse',
