						...
						<v-form
							...
							<v-container>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="StaticDateMonth"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Static Date Month"
											hint="Static Date Month"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="StaticDateDay"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Static Date Day"
											hint="Static Date Day"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-switch
											v-model="ObservationDayStatic"
											label="Observation Day Static"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-switch>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="ObservationDayStaticMonth"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Observation Day Static Month"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="ObservationDayStaticDay"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Observation Day Static Day"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-switch
											v-model="ObservationDayActivateIfWeekend"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-switch
											v-model="IsFirstMondayInMonthDate"
											label="First Monday In Month Date"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-switch>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="FirstMondayMonth"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="First Monday Month"
											hint="First Monday Month"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-switch
											v-model="IsThirdMondayInMonthDate"
											label="Third Monday In Month Date"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-switch>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="ThirdMondayMonth"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Third Monday Month"
											hint="Third Monday Month"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-switch
											v-model="IsSecondMondayInMonthDate"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="SecondMondayMonth"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Second Monday Month"
											hint="Second Monday Month"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-switch
											v-model="IsMondayBeforeDate"
											label="Monday Before Date"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-switch>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="MondayBeforeDateMonth"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Monday Before Date Month"
											hint="Monday Before Date Month"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="MondayBeforeDateDay"
											type="number"
											step="1"
											autocomplete="newpassword"
											label="Monday Before Date Day"
											hint="Monday Before Date Day"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
		...
		<v-footer
			...
			<v-row
				...
				<v-btn
					...
					text
					rounded
					@click="DialoguesOpen({ name: 'DeleteLabourHolidayDialogue', state: {
