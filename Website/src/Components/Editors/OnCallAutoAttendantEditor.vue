	...
	<div>
						...
						<v-form
							...
							<v-container>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										...
										<v-text-field
											...
											label="Name"
											id="Name"
											hint="The name of this responder."
											persistent-hint
											:rules="[
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="FailoverNumber"
											autocomplete="newpassword"
											label="Failover Number"
											id="FailoverNumber"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="NoAgentResponseNotificationNumber"
											autocomplete="newpassword"
											label="No Agent Response Notification Number"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="NoAgentResponseNotificationEMail"
											autocomplete="newpassword"
											label="No Agent Response Notification E-Mail"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											v-model="MarkedHandledNotificationEMail"
											autocomplete="newpassword"
											label="Voicemail Handled Notification E-Mail"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										...
										<div class="subtitle" style="font-weight: bold; margin-top: 15px;">Who gets called, and in what order?</div>
									</v-col>
								</v-row>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<div class="subtitle" style="font-weight: bold; margin-bottom: 15px;">Call attempts to each calendar before giving up.</div>
										<v-slider
											v-model="CallAttemptsToEachCalendarBeforeGivingUp"
											label="Minutes"
											max="5"
											min="1"
											thumb-label
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<div class="subtitle" style="font-weight: bold; margin-bottom: 15px;">Minutes between each call attempt.</div>
										<v-slider
											v-model="MinutesBetweenCallAttempts"
											label="Minutes"
											max="60"
											min="1"
											thumb-label
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										...
										<MessagePromptEditor
											v-model="MessagePromptAskForCallbackNumber"
											:disabled="connectionStatus != 'Connected' || !PermOnCallAutoAttendantsCanPush()"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										...
										<MessagePromptEditor
											v-model="MessagePromptAskForMessage"
											:disabled="connectionStatus != 'Connected' || !PermOnCallAutoAttendantsCanPush()"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										...
										<MessagePromptEditor 
											v-model="MessagePromptThankYouAfter" 
											:disabled="connectionStatus != 'Connected' || !PermOnCallAutoAttendantsCanPush()"
		...
		<v-footer
			...
			<v-row
				...
				>
				<v-btn
					:disabled="!value || connectionStatus != 'Connected' || !PermOnCallAutoAttendantsCanDelete()"
					color="white"
					text
					rounded
					@click="OpenDeleteOnCallAutoAttendant()"
					>
