	...
	<v-card style="margin: 4px; margin-top: 10px; margin-bottom: 10px;">
		<v-card-text>
			...
			<v-alert type="info" colored-border elevation="2" border="bottom">
				This account will be made with employee permissions, if they need more permissions you can add them in settings.
			</v-alert>
				...
				<v-row no-gutters>
					<v-col cols="12">
						<v-text-field
							...
							autocomplete="newpassword"
							label="E-Mail"
							hint="They will always log in with their email address"
							:rules="[ ValidateRequiredField ]"
							type="email"
							>
						</v-text-field>
