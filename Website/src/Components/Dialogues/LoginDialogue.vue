		...
		<v-card>
			...
			<v-row no-gutters>
				<v-col  class="d-none d-sm-block" cols="12" sm="6" style="padding: 30px; text-align: center;">
					<p><img src="@/assets/Dispatch Pulse Logo v1.svg" style="max-width: 64px; border-radius: 10px;" /></p>
					<p class="d-none d-sm-block" style="font-size: 24px; text-align: center;">Dispatch Pulse</p>
					<p class="d-none d-sm-block" >
						<v-btn color="primary" href="https://www.dispatchpulse.com/Contact" target="_blank" style="width: 150px;">
					...
					<p class="d-none d-sm-block" ><v-btn color="primary" @click="OnClickTryADemo" style="width: 150px;">Take a Look</v-btn></p>
					
					<p class="d-none d-sm-block" ><v-btn @click="OnClickLearnMore" style="width: 150px;">Learn More</v-btn></p>
					...
					<v-form @keyup.native.enter="OnClickLogin">
						<v-container>
							<v-row style="margin-top: 12px; margin-bottom: 15px;">
								<v-col cols="10" sm="10" offset="1" style="padding: 0px; margin-top:0px; margin-bottom:0px;">
									...
									<v-card-title class="headline" style="padding:0px; display: flex;">
										<img class="d-inline d-sm-none" src="@/assets/Dispatch Pulse Logo v1.svg" style="max-width: 64px; border-radius: 10px; margin-right: 10px;" /> 
										<div style="flex: 1; word-break: break-word;"><span class="d-inline d-sm-none">Dispatch Pulse </span>Login</div>
									</v-card-title>
								</v-col>
							</v-row>
							...
							<v-row style="margin-top: 15px; margin-bottom: 20px;">
								<v-col cols="10" sm="10" offset="1" style="padding: 0px; margin-top:0px; margin-bottom:0px;">
									<v-text-field
										...
										persistent-hint
										class="e2e-login-company-abbreviation"
										>
									</v-text-field>
								</v-col>
							</v-row>
							...
							<v-row style="margin-top: 20px; margin-bottom: 20px;">
								<v-col cols="10" sm="10" offset="1" style="padding: 0px; margin-top:0px; margin-bottom:0px;">
									<v-text-field
										v-model="contactPassword"
										label="Password"
										prepend-icon="lock_outline"
										type="password"
										class="e2e-login-password"
										>
									</v-text-field>
								</v-col>
							</v-row>
							<v-row>
								<v-col cols="10" offset="1" style="padding: 0px;">
									<v-card-actions>
										<v-btn color="primary" @click="OnClickSignUp" class="d-flex d-sm-none" style="min-width: 120px;">Sign Up</v-btn>
										<v-spacer></v-spacer>
										<v-btn
											color="primary"
											@click="OnClickLogin"
							...
							<v-row class="d-block d-sm-none">
								<v-col cols="10" offset="1" style="padding: 0px;">
									<v-card-actions>
										<v-btn text style="min-width: 120px; text-align: center;" @click="OnClickTryADemo">Try a Demo</v-btn>
										<v-spacer></v-spacer>
										<v-btn text style="min-width: 120px; text-align: center;" @click="OnClickLearnMore">Learn More</v-btn>
									</v-card-actions>
								</v-col>
							</v-row>
						</v-container>
