...
export default class DeleteOnCallAutoAttendantDialogue2 extends DialogueBase2 {
...
Vue.component('DeleteOnCallAutoAttendantDialogue2', DeleteOnCallAutoAttendantDialogue2);
