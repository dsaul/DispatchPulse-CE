		...
		<div v-else>
			...
			<div v-else>
				...
				<AssignmentsList
					...
					:showFilter="false"
					:rowsPerPage="5"
					:showOnlyForBillingUsersAgent="true"
					:showOnlyOpenAssignments="true"
					:showOnlyTodayOrEarlier="true"
					:hideAssignmentsWithNoStartTime="true"
					:focusIsProject="true"
					emptyMessage="There are no assignments scheduled for today."
					:disabled="disabled"
					/>
				...
				<AssignmentsList
					...
					:showOnlyForBillingUsersAgent="true"
					:showOnlyOpenAssignments="true"
					:showOnlyTasksWithNoStartTime="true"
					:focusIsProject="true"
					emptyMessage="There are no unscheduled assignments."
					:disabled="disabled"
					/>
			...
			<v-card-actions style="flex-wrap: wrap;">
				<v-btn
					:to="`/section/agents/${agentId}?tab=Agenda`"
					text
					style="margin-left: 0px;"
					class="e2e-my-agenda-today-card-see-full-agenda"
					:disabled="!PermAgentDisplayOwn()"
					>
					See Full Agenda
				</v-btn>
				<v-btn
					...
					style="margin-left: 0px;"
					class="e2e-my-agenda-today-card-add-assignment"
					:disabled="disabled || !PermAssignmentCanPush()"
					>
					Add Assignment
				</v-btn>
				<v-spacer></v-spacer>
