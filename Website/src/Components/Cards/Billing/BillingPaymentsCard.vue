<template>
	<v-card>
		...
		<div v-if="IsInvoiceBilling">
			...
			<div v-if="PermBillingCanMakeOneTimeCompanyCreditCardPayments">
				...
				<v-card-text style="padding-bottom: 0px;">
					...
					<input
						type="text"
						value="accounts.receivable@saulandpartners.ca"
						style="width: 270px; text-align: center; border: 1px dashed #ccc;"
						readonly
						/>.
		...
		<v-card-text style="color: black;padding-bottom: 0px;">
			Pre-authorized payments will debit the current balance of your account on or just after the 1st of each month.
		</v-card-text>
