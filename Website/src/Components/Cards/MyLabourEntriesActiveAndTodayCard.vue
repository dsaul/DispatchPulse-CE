		...
		<div v-else>
			...
			<div v-else>
				<LabourList
					...
					:showOnlyActiveAndToday="true"
					:focusIsProject="true"
					:showDateFilters="false"
					emptyMessage="There are no labour entries today."
					:disabled="disabled"
					/>
			</div>
			<v-card-actions style="flex-wrap: wrap;">
				<v-btn
					text
					:to="`/section/agents/${agentId}?tab=Labour`"
				...
				<v-btn 
					...
					style="margin-left: 0px;"
					class="e2e-my-labour-entries-active-and-today-card-add-manual-entry"
