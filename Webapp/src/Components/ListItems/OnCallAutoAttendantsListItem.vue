<template>
	<div class="e2e-on-call-auto-attendants-list-item">
		<v-list-item>
			<v-list-item-avatar>
				...
				<v-menu bottom left>
					...
					<v-list dense>
						...
						<v-list-item
							...
							:disabled="disabled || !PermOnCallAutoAttendantsCanDelete()"
							>
							<v-list-item-icon>
...
export default class OnCallAutoAttendantsListItem extends ListItemBase {
