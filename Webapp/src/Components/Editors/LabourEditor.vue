	...
	<div>
							...
							<v-container>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-select
											...
											persistent-hint
											v-model="TypeId"
											class="e2e-labour-editor-labour-type"
											:disabled="connectionStatus != 'Connected'"
											:readonly="!PermCRMLabourManualEntries()"
											>
								...
								<v-row v-if="TypeIsException">
									<v-col cols="12" sm="8" offset-sm="2">
										<v-select
											:disabled="connectionStatus != 'Connected'"
											:items="AllLabourSubtypeExceptionTypes()"
								...
								<v-row v-if="TypeIsHoliday">
									<v-col cols="12" sm="8" offset-sm="2">
										<v-select
											:disabled="connectionStatus != 'Connected'"
											:items="AllLabourSubtypeHolidaysTypes()"
											label="Holiday Type"
								...
								<v-row v-if="TypeIsNonBillable">
									<v-col cols="12" sm="8" offset-sm="2">
										<v-select
											:disabled="connectionStatus != 'Connected'"
											:items="AllLabourSubtypeNonBillableTypes()"
										...
										<v-col cols="12" sm="8" offset-sm="2" style="padding-top: 0px; padding-bottom: 0px;">
											<v-radio-group
												...
												<v-radio
													...
													value="start-stop-timestamp"
													color="primary"
													class="e2e-time-mode-start-stop-timestamp"
													>
												</v-radio>
											</v-radio-group>
										</v-col>
											...
											<p>
												<v-input
													...
													<v-date-picker
														...
														value="ISO 8601"
														:elevation="1"
														class="e2e-date-and-hours-date-picker"
														:disabled="connectionStatus != 'Connected' || !PermCRMLabourManualEntries()"
														>
													</v-date-picker>
												</v-input>
											...
											<p style="margin-top: 40px;">
												<v-slider
													...
													<template v-slot:append>
														<v-text-field
															v-model="Hours"
															class="mt-0 pt-0 e2e-hours-text-field"
															hide-details
															single-line
															type="number"
															step="0.5"
								...
								<v-row v-if="TypeIsBillable || TypeIsHoliday || TypeIsNonBillable || TypeIsException || TypeIsPayOutBanked">
									<v-col cols="12" sm="8" offset-sm="2">
								...
								<v-row v-if="TypeIsBillable">
									<v-col
										...
										<v-switch
											...
											:persistent-hint="LabourForcedExtra"
											class="e2e-is-extra"
											>
										</v-switch>
										<v-switch
		...
		<v-footer
			...
			<v-btn
				...
				text
				rounded
				@click="DialoguesOpen({ name: 'DeleteLabourDialogue', state: {
