<template>
	<div>
		...
		<v-app-bar
			...
			<v-toolbar-title class="white--text">Labour Exception</v-toolbar-title>
			...
			<v-container>
				<v-row>
					<v-col cols="12" sm="8" offset-sm="2">
						<div class="title">Labour Exception Not Found</div>
					</v-col>
				</v-row>
				<v-row>
					<v-col cols="12" sm="8" offset-sm="2">
						...
						<ul>
							...
							<li>The labour exception no longer exists and this is an old bookmark.</li>
							<li>Someone deleted the labour exception while you were opening it.</li>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											...
											class="e2e-labour-exception-editor-name"
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											...
											:rules="[ ValidateRequiredField ]"
											class="e2e-labour-exception-editor-description"
											:disabled="connectionStatus != 'Connected'"
											>
										</v-text-field>
									</v-col>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										<v-text-field
											...
											readonly="readonly"
											label="Unique ID"
											hint="The id of this labour exception type."
											>
										</v-text-field>
									</v-col>
								</v-row>
		...
		<v-footer
			...
			<v-row
				...
				<v-btn
					...
					text
					rounded
					@click="DialoguesOpen({ name: 'DeleteLabourExceptionDialogue', state: {
...
export default class LabourExceptionEditor extends EditorBase {

	@Prop({ default: null }) declare public readonly value: ILabourSubtypeException | null;
