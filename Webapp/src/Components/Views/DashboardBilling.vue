<template>
	...
	<div>
		...
		<v-app-bar color="#747389" dark fixed app clipped-right >
			...
			<v-toolbar-title class="white--text">Billing Dashboard</v-toolbar-title>
			...
			<template v-slot:extension>
				...
				<v-tabs
					...
					<v-tab
						...
						class="e2e-dashboard-tab-billing"
						:disabled="!PermCRMViewDashboardBillingTab()"
						>
						All
					</v-tab>
		...
		<v-tabs-items v-model="tab" style="background: transparent;">
			...
			<v-tab-item style="flex: 1;">
				<div v-if="PermCRMViewDashboardBillingTab()">
					<AssignmentsInBillableReviewCard
						ref="assignmentsInBillableReviewCard"
...
export default class Dashboard extends ViewBase {
	...
	public $refs!: {
		assignmentsInBillableReviewCard: AssignmentsInBillableReviewCard,
	...
	public ReLoadData(): void {
		...
		if (this.$refs.assignmentsInBillableReviewCard) {
			this.$refs.assignmentsInBillableReviewCard.LoadData();
		}
	...
	public get IsLoadingData(): boolean {
		...
		if (this.$refs.assignmentsInBillableReviewCard && this.$refs.assignmentsInBillableReviewCard.IsLoadingData) {
			return true;
		}
