<template>
	...
	<div>
		...
		<v-app-bar color="#747389" dark fixed app clipped-right >
			...
			<v-toolbar-title class="white--text">Agent Dashboard</v-toolbar-title>
		...
		<v-tabs-items v-model="tab" style="background: transparent;">
			...
			<v-tab-item style="flex: 1;">
				<MyAgendaTodayCard
					ref="myAgendaTodayCard"
					:disabled="connectionStatus != 'Connected'"
					/>
				<MyLabourEntriesActiveAndTodayCard
					ref="myLabourEntriesActiveAndTodayCard"
					:disabled="connectionStatus != 'Connected'"
					/>
			</v-tab-item>
...
export default class Dashboard extends ViewBase {
	...
	public $refs!: {
		myAgendaTodayCard: MyAgendaTodayCard,
		myLabourEntriesActiveAndTodayCard: MyLabourEntriesActiveAndTodayCard,
	...
	public ReLoadData(): void {
		...
		if (this.$refs.myAgendaTodayCard) {
			this.$refs.myAgendaTodayCard.LoadData();
		}
		if (this.$refs.myLabourEntriesActiveAndTodayCard) {
			this.$refs.myLabourEntriesActiveAndTodayCard.LoadData();
		}
	...
	public get IsLoadingData(): boolean {
		...
		if (this.$refs.myAgendaTodayCard && this.$refs.myAgendaTodayCard.IsLoadingData) {
			return true;
		}
		if (this.$refs.myLabourEntriesActiveAndTodayCard && this.$refs.myLabourEntriesActiveAndTodayCard.IsLoadingData) {
			return true;
		}
