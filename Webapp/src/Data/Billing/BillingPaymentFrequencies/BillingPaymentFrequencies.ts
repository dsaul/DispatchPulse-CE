...
export class BillingPaymentFrequencies {
	// RPC Methods
	public static RequestBillingPaymentFrequenciesForCurrentSession = 
		RPCMethod.Register<RPCRequestBillingPaymentFrequenciesForCurrentSession>(
			new RPCRequestBillingPaymentFrequenciesForCurrentSession());
	
	public static GetMerged(mergeValues: Record<string, any>): IBillingPaymentFrequencies {
	...
	public static ValidateObject(o: IBillingPaymentFrequencies): IBillingPaymentFrequencies {
