...
export default class CRMNavigation {
	...
	public static PermCRMNavigationShowAddressBook(): boolean {
		...
		const ret = 
			perms.indexOf('crm.navigation.show.address-book') !== -1;
	...
	public static PermCRMNavigationShowAllContacts(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.all-contacts') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowAllCompanies(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.all-companies') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowProjects(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.projects') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowAllProjects(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.all-projects') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowAllAssignments(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.all-assignments') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowAssignmentStatusDefinitions(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.assignment-status-definitions') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowProjectStatusDefinitions(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.project-status-definitions') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowAgents(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.agents') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowAllAgents(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.all-agents') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowEmploymentStatusDefinitions(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.employment-status-definitions') !== -1;
		return ret;
	}
	public static PermCRMNavigationShowLabourExceptionDefinitions(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.labour-exception-definitions') !== -1;
		return ret;
	}
	public static PermCRMNavigationShowLabourHolidaysDefinitions(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.labour-holidays-definitions') !== -1;
		return ret;
	}
	public static PermCRMNavigationShowLabourNonBillableDefinitions(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.labour-non-billable-definitions') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowReports(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.reports') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowAllReports(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.all-reports') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowSettings(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.settings') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowPhoneServices(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.phone-services') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowPhoneServicesPhoneNumbers(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.phone-services-phone-numbers') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowPhoneServicesRecordings(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.phone-services-recordings') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowPhoneServicesOnCallResponders(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.phone-services-on-call-responders') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowPhoneServicesCalendars(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.phone-services-calendars') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationShowPhoneServicesVoicemails(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.navigation.show.phone-services-voicemails') !== -1;
		return ret;
	}
	...
	public static PermCRMNavigationLicensedOnCall(): boolean {
		...
		if (!contact ||
			!contact.json ||
			!contact.json.licenseAssignedOnCall) {
			return false;
		}
