	...
	<div>
		...
		<v-app-bar
			...
			<HelpMenuButton>
				...
				<v-list-item
					@click="OpenMicrosoft365Tutorial()"
					>
					<v-list-item-icon>
						<v-icon>book</v-icon>
					</v-list-item-icon>
				...
				<v-list-item
					@click="OpenAppleICloudCalendarTutorial()"
					>
					<v-list-item-icon>
						<v-icon>book</v-icon>
					</v-list-item-icon>
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										...
										<v-text-field
											...
											label="Name"
											id="Name"
											hint="The name of this calendar."
											persistent-hint
											:rules="[
								...
								<v-row>
									<v-col cols="12" sm="8" offset-sm="2">
										...
										<v-alert
											...
											elevation="2"
											>
											Click on the below for instructions on how to get the web link from some popular calendar services.
											<ul>
												<li><a href="https://www.dispatchpulse.com/Support/Calendar/HowToAddAGoogleCalendarToOnCallResponder" target="_blank">Google Calendar</a></li>
												<li><a href="https://www.dispatchpulse.com/Support/Calendar/HowToAddAOffice365CalendarToOnCallResponder" target="_blank">Microsoft Office 365</a></li>
												<li><a href="https://www.dispatchpulse.com/Support/Calendar/HowToAddAAppleICloudCalendarToOnCallResponder" target="_blank">Apple iCloud Calendar</a></li>
											</ul>
										</v-alert>
									</v-col>
								</v-row>
		...
		<v-footer
			...
			<v-row
				...
				>
				<v-btn
					:disabled="!value || connectionStatus != 'Connected' || !PermCalendarsCanDelete()"
					color="white"
					text
					rounded
					@click="OpenDeleteCalendar()"
					>
