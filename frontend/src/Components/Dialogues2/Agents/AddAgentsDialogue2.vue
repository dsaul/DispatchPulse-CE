	...
	<v-dialog v-model="isOpen" persistent scrollable :fullscreen="MobileDeviceWidth()">
		<v-card>
			...
			<v-card-text>
				...
				<AgentEditor ref="editor" v-model="EditorValue" :showAppBar="false" :showFooter="false"
...
import { IAgent } from '@/Data/CRM/Agent/Agent';
...
export default class AddAgentDialogue2 extends DialogueBase2 {
	...
	protected get EditorValue(): IAgent | null {
		return this.value;
	}

	protected set EditorValue(val: IAgent | null) {
