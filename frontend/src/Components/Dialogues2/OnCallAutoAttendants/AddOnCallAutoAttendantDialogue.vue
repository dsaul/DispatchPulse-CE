<template>
	<v-dialog v-model="isOpen" persistent scrollable :fullscreen="MobileDeviceWidth()">
		<v-card>
			<v-card-title>Add OnCallAutoAttendant</v-card-title>
			<v-divider></v-divider>
			<v-card-text>

				<OnCallAutoAttendantEditor ref="editor" v-model="EditorValue" :showAppBar="false" :showFooter="false"
...
export default class AddOnCallAutoAttendantDialogue extends DialogueBase2 {
