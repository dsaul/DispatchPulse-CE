<template>
	<v-dialog v-model="isOpen" persistent scrollable :fullscreen="MobileDeviceWidth()">
		<v-card>
			<v-card-title>Edit Recording</v-card-title>
			<v-divider></v-divider>
			<v-card-text>

				<RecordingEditor ref="editor" v-model="EditorValue" :showAppBar="false" :showFooter="false"
					preselectTabName="Admin" :isMakingNew="false" :isDialogue="true" />
...
export default class EditRecordingDialogue extends DialogueBase2 {
