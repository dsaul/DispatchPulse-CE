<template>
	<div>
		<AgentSelectField v-for="(entry, index) in value" :key="index" v-model="value[index]" @input="PostChanged()"
			:index="index" :isFirstIndex="index === 0" :isLastIndex="index === value.length - 1"
