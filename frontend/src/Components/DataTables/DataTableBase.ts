...
export default class DataTableBase extends Vue {
	...
	protected ProjectCombinedDescriptionForId =
		Project.CombinedDescriptionForId;
	...
	protected LabourSubtypeExceptionNameForId =
		LabourSubtypeException.NameForId;
	protected LabourSubtypeExceptionIconForId =
		LabourSubtypeException.IconForId;
	...
	protected LabourSubtypeNonBillableNameForId =
		LabourSubtypeNonBillable.NameForId;
	protected LabourSubtypeNonBillableIconForId =
		LabourSubtypeNonBillable.IconForId;
}
