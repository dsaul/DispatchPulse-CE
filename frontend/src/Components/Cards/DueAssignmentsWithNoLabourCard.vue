<template>
	<v-card class="e2e-due-assignments-no-labour-card" style="margin: 30px; margin-top: 15px;">
		...
		<v-card-text>
			<AssignmentsList ref="assignmentsList" :showOnlyDueWithNoLabour="true" :showAwaitingPayment="false"
