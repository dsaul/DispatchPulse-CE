<template>
	<v-card class="e2e-due-projects-with-no-labour-card" style="margin: 30px; margin-top: 15px;">
		<v-progress-linear v-if="loadingData" indeterminate></v-progress-linear>
		<v-card-title>Due Projects With No Labour</v-card-title>
		<v-card-text>
			<ProjectList ref="projectList" :showOnlyDueWithNoLabour="true" :showAwaitingPayment="false" :showOpen="true"
				:showClosed="false"
