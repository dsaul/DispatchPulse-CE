	...
	<div class="notification-bell-button">
		...
		<v-menu bottom left offset-y>
			<template v-slot:activator="{ on }">
				<v-badge :content="currentNotificationCount" :value="currentNotificationCount" color="red" overlap
					offset-x="25" offset-y="25">
			...
			<v-list dense>
				...
				<v-list-item v-if="currentNotificationCount != 0">
					<v-list-item-content>
						<v-list-item-title>Notifications</v-list-item-title>
					</v-list-item-content>
					<v-list-item-action>
						<v-btn text small @click="DoClearAll()" :disabled="currentNotificationCount == 0">
							Clear All
						</v-btn>
				...
				<!-- <v-divider /> -->
				<v-list-item v-if="currentNotificationCount == 0" disabled>
					<v-list-item-content>
						<v-list-item-title>No Notifications</v-list-item-title>
					</v-list-item-content>
				</v-list-item>

				<v-list-item two-line v-for="(notification, index) in this.currentNotifications" :key="index">
					<v-list-item-icon style="margin: 0px; margin-top: 20px; margin-right: 10px;">
					...
					<v-list-item-action @click="DoClearIndex(index)">
						<v-btn icon>
