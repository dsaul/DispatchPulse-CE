		...
		<v-list-item>
			...
			<v-list-item-content @click="ClickEntry">
				...
				<v-list-item-subtitle style="width: 1px; /*to force flex to allow this to get smaller*/">
					...
					<v-tooltip
						v-if="IsLicensedForProjectsSchedulingAndTime"
						top
						>
			...
			<v-list-item-action v-if="showMenuButton">
				<v-menu bottom left>
					...
					<v-list dense>
						<v-list-item
							:disabled="isDialogue || disabled || IsOwnBillingContact"
						...
						<v-list-item
							...
							:disabled="disabled || IsOwnBillingContact"
							>
							<v-list-item-icon>
