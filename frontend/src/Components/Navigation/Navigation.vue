<template>
	<v-navigation-drawer
		width="260px"
		v-model="$store.state.drawers.showNavigation"
		fixed
		app
		style="z-index: 10"
		...
		<v-img
			...
			>
				...
				<v-avatar size="64px" style="margin-left: 32px; margin-top: 32px; filter: drop-shadow(2px 2px 2px rgba(0, 0, 0, 1));" color="indigo">
				...
				<div style="text-shadow: 2px 2px 2px rgba(0, 0, 0, 1); padding-left: 32px; padding-top: 5px; padding-bottom: 10px; background: rgba(0,0,0,0.4); color: white; min-height: 39px;">{{CurrentBillingContactEmail()}}</div>
		...
		<v-list expand>
			...
			<v-list-group
				...
				v-model="sideNavExpandDashboard"
				>
				...
				<v-list-item
					...
					to="/section/dashboard/agent"
					class="e2e-sidenav-dashboard"
				...
				<v-list-item
					v-if="cacheLicensedProjectsSchedulingTime"
					to="/section/dashboard/management"
					class="e2e-sidenav-dashboard"
					style="min-height: 25px; padding-left:72px;"
					dense
					>
			...
			<v-list-group
				v-if="cachePermCRMNavigationShowAddressBook"
				...
				<v-list-item
					v-if="cachePermCRMNavigationShowAllContacts"
					dense
					to="/section/contacts/index"
					style="min-height: 25px; padding-left:72px;"
					class="e2e-sidenav-all-contacts"
					>
				...
				<v-list-item
					v-if="cachePermCRMNavigationShowAllCompanies"
					dense
					to="/section/companies/index"
					style="min-height: 25px; padding-left:72px;"
					class="e2e-sidenav-all-companies"
					>
					<v-list-item-content style="padding: 0px;">
			...
			<v-list-group
				v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowProjects"
				prepend-icon="assignment"
				v-model="sideNavExpandProjects"
				>
				<template v-slot:activator>
				...
				<v-list-item
					v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowAllProjects"
					dense
					to="/section/projects"
					style="min-height: 25px; padding-left:72px;"
				...
				<v-list-item
					v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowAllAssignments"
					dense
				...
				<v-list-item
					v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowAllMaterialEntries"
					dense
					to="/section/material-entries"
					style="min-height: 25px; padding-left:72px;"
				...
				<v-list-group
					v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowProjectDefinitions"
					dense
					no-action
					sub-group
					v-model="sideNavExpandProjectDefinitions"
					...
					<v-list-item 
						...
						dense
						to="/section/project-status-definitions"
						style="min-height: 25px; padding-left:72px;"
			...
			<v-list-group
				v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowAgents"
				prepend-icon="directions_walk"
				v-model="sideNavExpandAgents"
				>
				<template v-slot:activator>
					<v-list-item-title>Agents &amp; Time</v-list-item-title>
				</template>
				<v-list-item 
					v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowAllAgents"
					dense
					to="/section/agents"
					style="min-height: 25px; padding-left:72px;"
					class="e2e-sidenav-all-agents"
					>
					<v-list-item-content style="padding: 0px;">
				...
				<v-list-item 
					v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowAllLabourEntries"
					dense
					to="/section/labour"
					style="min-height: 25px; padding-left:72px;"
				...
				<v-list-group
					v-if="cacheLicensedProjectsSchedulingTime && cachePermCRMNavigationShowAgentsDefinitions"
					dense
					no-action
					sub-group
					v-model="sideNavExpandAgentDefinitions"
					style="min-height: 0px;"
					...
					<v-list-item 
						...
						dense
						to="/section/labour-holiday-definitions"
						style="min-height: 25px; padding-left:72px;"
					...
					<v-list-item 
						...
						dense
						to="/section/labour-non-billable-definitions"
						style="min-height: 25px; padding-left:72px;"
			...
			<v-list-group
				v-if="cacheLicensedOnCall && cachePermCRMNavigationShowPhoneServices"
				prepend-icon="phone"
				...
				<v-list-item 
					v-if="cacheLicensedOnCall && cachePermCRMNavigationShowPhoneServicesVoicemails"
					dense
				...
				<v-list-group
					v-if="cacheLicensedOnCall && cachePermCRMNavigationShowPhoneServicesSetup"
					dense
					no-action
					sub-group
					v-model="sideNavExpandPhoneServicesSetup"
					style="min-height: 0px;"
					class="e2e-sidenav-project-definitons-expander"
					>
					<template v-slot:activator>
					...
					<v-list-item 
						v-if="cacheLicensedOnCall && cachePermCRMNavigationShowPhoneServicesPhoneNumbers"
						dense
						to="/section/dids"
						style="min-height: 25px; padding-left:72px;"
						class="e2e-sidenav-all-reports"
					...
					<v-list-item 
						v-if="cacheLicensedOnCall && cachePermCRMNavigationShowPhoneServicesOnCallResponders"
						dense
						to="/section/on-call"
						style="min-height: 25px; padding-left:72px;"
						class="e2e-sidenav-all-reports"
					...
					<v-list-item 
						v-if="cacheLicensedOnCall && cachePermCRMNavigationShowPhoneServicesRecordings"
						dense
					...
					<v-list-item 
						v-if="cacheLicensedOnCall && cachePermCRMNavigationShowPhoneServicesCalendars"
						dense
			...
			<v-list-group
				v-if="cachePermCRMNavigationShowReports"
				...
				<v-list-item 
					v-if="cachePermCRMNavigationShowAllReports"
					dense
					to="/section/reports"
					style="min-height: 25px; padding-left:72px;"
					class="e2e-sidenav-all-reports"
			...
			<v-divider />
			<v-list-item
				v-if="cachePermCRMNavigationShowSettings"
				to="/settings"
				class="e2e-sidenav-settings"
				>
				<v-list-item-action>
