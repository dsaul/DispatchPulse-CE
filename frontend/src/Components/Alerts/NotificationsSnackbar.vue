<template>
	<div style="z-index: 256;">
		<v-snackbar
			:value="currentSnackbarNotification != null"
			:timeout="-1"
			top
			:color="SnackbarColor()"
			class="notification-bell-snackbar"
			absolute
			style="position: fixed;"
			>
			
			<span v-if="this.currentSnackbarNotification">{{this.currentSnackbarNotification.message || 'No message?'}}</span>
