...
import EmploymentStatusDataTable from '@/Components/DataTables/EmploymentStatusDataTable.vue';
import CSVDownloadAgentsEmploymentStatuses from '@/Data/CRM/EmploymentStatus/CSVDownloadAgentsEmploymentStatuses';
...
export default class EmploymentStatusDefinitions extends ViewBase {
	...
	public breadcrumbs = [
		...
		{
			text: 'Employment Status Definitions',
			disabled: true,
