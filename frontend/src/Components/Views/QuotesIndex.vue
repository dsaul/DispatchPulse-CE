<template>
	...
	<div>
		...
		<v-app-bar color="#747389" dark fixed app clipped-right >
			...
			<v-toolbar-title class="white--text">All Quotes</v-toolbar-title>
			...
			<template v-slot:extension>
				...
				>
					...
					<v-tab @click="$router.replace({query: { ...$route.query, tab: 'Quotes'}}).catch(((e) => {}));">
						Quotes
					</v-tab>
				</v-tabs>
			</template>
...
export default class QuotesIndex extends ViewBase {
