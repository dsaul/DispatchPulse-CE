...
export interface IRequestBillingSessionsForCurrentSessionCB
...
export class RPCRequestBillingSessionsForCurrentSession extends RPCMethod {
	public Send(
		payload: IRequestBillingSessionsForCurrentSessionPayload
	): IRoundTripRequest {
	...
	public RecieveDefaultAction(
		...
		payload: IRequestBillingSessionsForCurrentSessionCB
	): boolean {
