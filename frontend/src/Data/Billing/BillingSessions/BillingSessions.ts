...
export class BillingSessions {
	// RPC Methods
	public static PushBillingSessionAgentId = 
		RPCMethod.Register<RPCPushBillingSessionAgentId>(new RPCPushBillingSessionAgentId());
	public static PushBillingSessionContactId = 
		RPCMethod.Register<RPCPushBillingSessionContactId>(new RPCPushBillingSessionContactId());
	public static PushBillingSessionEMail = 
		RPCMethod.Register<RPCPushBillingSessionEMail>(new RPCPushBillingSessionEMail());
	public static PushBillingSessionEMailListMarketing = 
		RPCMethod.Register<RPCPushBillingSessionEMailListMarketing>(new RPCPushBillingSessionEMailListMarketing());
	public static PushBillingSessionEMailListTutorials = 
		RPCMethod.Register<RPCPushBillingSessionEMailListTutorials>(new RPCPushBillingSessionEMailListTutorials());
	public static PushBillingSessionMarketingCampaign = 
		RPCMethod.Register<RPCPushBillingSessionMarketingCampaign>(new RPCPushBillingSessionMarketingCampaign());
	public static PushBillingSessionName = 
		RPCMethod.Register<RPCPushBillingSessionName>(new RPCPushBillingSessionName());
	public static PushBillingSessionPhone = 
		RPCMethod.Register<RPCPushBillingSessionPhone>(new RPCPushBillingSessionPhone());
	public static RequestBillingSessionsForCurrentSession = 
		RPCMethod.Register<RPCRequestBillingSessionsForCurrentSession>(new RPCRequestBillingSessionsForCurrentSession());
	public static PerformCreateBillingSessionForCredentials = 
		RPCMethod.Register<RPCPerformCreateBillingSessionForCredentials>(new RPCPerformCreateBillingSessionForCredentials());
	public static PerformLogOutSession = 
		RPCMethod.Register<RPCPerformLogOutSession>(new RPCPerformLogOutSession());
	
	public static GetMerged(mergeValues: Record<string, any>): IBillingSessions {
