...
export interface IPushBillingSessionContactIdPayload extends IIdempotencyRequest {
...
export class RPCPushBillingSessionContactId extends RPCMethod {
	public Send(payload: IPushBillingSessionContactIdPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IPushBillingSessionContactIdCB): boolean {
