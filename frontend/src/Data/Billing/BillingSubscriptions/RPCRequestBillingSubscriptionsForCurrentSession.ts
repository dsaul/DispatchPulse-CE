...
export interface IRequestBillingSubscriptionsForCurrentSessionCB extends IIdempotencyResponse {
	billingSubscriptions: IBillingSubscriptions[];
}

export class RPCRequestBillingSubscriptionsForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingSubscriptionsForCurrentSessionPayload): IRoundTripRequest {
