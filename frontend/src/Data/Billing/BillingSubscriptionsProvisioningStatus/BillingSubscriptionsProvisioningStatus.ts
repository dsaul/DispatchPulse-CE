...
export class BillingSubscriptionsProvisioningStatus {
	// RPC Methods
	public static RequestBillingSubscriptionsProvisioningStatusForCurrentSession = RPCMethod.Register<
		RPCRequestBillingSubscriptionsProvisioningStatusForCurrentSession
	...
	public static ValidateObject(
		o: IBillingSubscriptionsProvisioningStatus
	): IBillingSubscriptionsProvisioningStatus {
		return o;
	}
	...
	public static PermBillingSubscriptionsProvisioningStatusCanRequest(): boolean {
		...
		const ret =
			perms.indexOf(
				"billing.subscription-provisioning-status.request-any"
			) !== -1 ||
			perms.indexOf(
				"billing.subscription-provisioning-status.request-company"
			) !== -1;
