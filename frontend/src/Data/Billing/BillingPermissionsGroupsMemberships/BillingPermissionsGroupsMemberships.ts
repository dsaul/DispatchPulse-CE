...
export class BillingPermissionsGroupsMemberships {
	// RPC Methods
	public static RequestBillingPermissionsGroupsMembershipsForCurrentSession = 
		RPCMethod.Register<RPCRequestBillingPermissionsGroupsMembershipsForCurrentSession>(
			new RPCRequestBillingPermissionsGroupsMembershipsForCurrentSession());
	public static PerformBillingPermissionsGroupsMembershipsAdd = 
		RPCMethod.Register<RPCPerformBillingPermissionsGroupsMembershipsAdd>(
			new RPCPerformBillingPermissionsGroupsMembershipsAdd());
	public static PerformBillingPermissionsGroupsMembershipsRemove = 
		RPCMethod.Register<RPCPerformBillingPermissionsGroupsMembershipsRemove>(
			new RPCPerformBillingPermissionsGroupsMembershipsRemove());
	
	public static GetMerged(mergeValues: Record<string, any>): IBillingPermissionsGroupsMemberships {
	...
	public static All(): Record<string, IBillingPermissionsGroupsMemberships> | null {
		
		const memberships = store.state.Database.billingPermissionsGroupsMemberships as { 
	...
	public static ForId(id: string | null): IBillingPermissionsGroupsMemberships | null {
	...
	public static ForBillingContactId(contactId: string | null): { 
		[id: string]: IBillingPermissionsGroupsMemberships; } {
	...
	public static ValidateObject(o: IBillingPermissionsGroupsMemberships): IBillingPermissionsGroupsMemberships {
	...
	public static PerformAddMemberships(billingContactId: string, permissionsGroupIds: string[]): IRoundTripRequest {
	...
	public static PerformRemoveMemberships(billingContactId: string, permissionsGroupIds: string[]): IRoundTripRequest {
	...
	public static PermBillingPermissionsGroupsMembershipsCanRequest(): boolean {
		...
		const ret = 
			perms.indexOf('billing.permissions-groups-memberships.read-any') !== -1 ||
			perms.indexOf('billing.permissions-groups-memberships.read-company') !== -1;
