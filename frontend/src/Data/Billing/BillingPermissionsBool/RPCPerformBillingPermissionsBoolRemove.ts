...
export interface IPerformBillingPermissionsBoolRemove
	extends IIdempotencyRequest {
	billingContactId: guid | null;
	permissionKeys: string[] | null;
}

export interface IPerformBillingPermissionsBoolRemoveCB
...
export class RPCPerformBillingPermissionsBoolRemove extends RPCMethod {
	public Send(
		payload: IPerformBillingPermissionsBoolRemove
	): IRoundTripRequest {
	...
	public RecieveDefaultAction(
		...
		payload: IPerformBillingPermissionsBoolRemoveCB
	): boolean {
		// Default action
