...
export interface IRequestBillingPermissionsBoolForCurrentSessionCB extends IIdempotencyResponse {
...
export class RPCRequestBillingPermissionsBoolForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingPermissionsBoolForCurrentSessionPayload): IRoundTripRequest {
