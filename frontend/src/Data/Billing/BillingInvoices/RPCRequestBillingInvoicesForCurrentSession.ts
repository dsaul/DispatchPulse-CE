...
export type IRequestBillingInvoicesForCurrentSessionPayload = IIdempotencyRequest
	...
	export interface IRequestBillingInvoicesForCurrentSessionCB extends IIdempotencyResponse {
		billingInvoices: IBillingInvoices[];
	}

export class RPCRequestBillingInvoicesForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingInvoicesForCurrentSessionPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IRequestBillingInvoicesForCurrentSessionCB): boolean {
