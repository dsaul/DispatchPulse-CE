...
export class BillingInvoices {
	// RPC Methods
	public static RequestBillingInvoicesForCurrentSession = RPCMethod.Register<
		RPCRequestBillingInvoicesForCurrentSession
	>(new RPCRequestBillingInvoicesForCurrentSession());
	...
	public static GetAll(): IBillingInvoices[] {
		...
		filtered = _.filter(billingInvoices, (o: IBillingInvoices) => {
