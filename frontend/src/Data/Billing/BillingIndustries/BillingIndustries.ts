...
export class BillingIndustries {
	// RPC Methods
	public static RPCRequestBillingIndustriesForCurrentSession = RPCMethod.Register<
		RPCRequestBillingIndustriesForCurrentSession
	>(new RPCRequestBillingIndustriesForCurrentSession());
