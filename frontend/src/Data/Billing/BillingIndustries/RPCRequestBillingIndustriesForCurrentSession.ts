...
export type IRequestBillingIndustriesForCurrentSessionPayload = IIdempotencyRequest
	...
	export interface IRequestBillingIndustriesForCurrentSessionCB extends IIdempotencyResponse {
		billingIndustries: IBillingIndustries[];
	}

export class RPCRequestBillingIndustriesForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingIndustriesForCurrentSessionPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IRequestBillingIndustriesForCurrentSessionCB): boolean {
