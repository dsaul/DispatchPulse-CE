...
export interface IRequestBillingPackagesForCurrentSessionCB
...
export class RPCRequestBillingPackagesForCurrentSession extends RPCMethod {
	public Send(
		payload: IRequestBillingPackagesForCurrentSessionPayload
	): IRoundTripRequest {
	...
	public RecieveDefaultAction(
		...
		payload: IRequestBillingPackagesForCurrentSessionCB
	): boolean {
