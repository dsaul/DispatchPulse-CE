...
import {
	BillingSessions,
	IBillingSessions
} from "../BillingSessions/BillingSessions";
...
export class BillingContacts {
	// RPC Methods
	public static RequestBillingContactsForCurrentSession = RPCMethod.Register<
		RPCRequestBillingContactsForCurrentSession
	>(new RPCRequestBillingContactsForCurrentSession());
	public static PerformChangeSessionPassword = RPCMethod.Register<
		RPCPerformChangeSessionPassword
	>(new RPCPerformChangeSessionPassword());
	public static PerformDeleteBillingContact = RPCMethod.Register<
		RPCPerformDeleteBillingContact
	>(new RPCPerformDeleteBillingContact());
	public static PerformRegisterAdditionalUsers = RPCMethod.Register<
		RPCPerformRegisterAdditionalUsers
	>(new RPCPerformRegisterAdditionalUsers());
	public static PerformRegisterMainUser = RPCMethod.Register<
		RPCPerformRegisterMainUser
	>(new RPCPerformRegisterMainUser());
	public static PerformUpdateBillingContactDetails = RPCMethod.Register<
		RPCPerformUpdateBillingContactDetails
	>(new RPCPerformUpdateBillingContactDetails());
	...
	public static All(): Record<string, IBillingContacts> | null {
		const billingContacts = store.state.Database.billingContacts as Record<
			string,
			IBillingContacts
		>;
	...
	public static Add(
		contact: IBillingContacts | null
	): IRoundTripRequest | null {
		if (!contact) {
			return null;
		}
	...
	public static CurrentBillingContactId(): string | null {
		...
		const sessions: Record<string, IBillingSessions> =
			store.state.Database.billingSessions;
		if (!sessions) {
			return null;
		}
