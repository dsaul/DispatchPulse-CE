...
export interface IRequestBillingCouponCodesForCurrentSessionCB
...
export class RPCRequestBillingCouponCodesForCurrentSession extends RPCMethod {
	public Send(
		payload: IRequestBillingCouponCodesForCurrentSessionPayload
	): IRoundTripRequest {
	...
	public RecieveDefaultAction(
		...
		payload: IRequestBillingCouponCodesForCurrentSessionCB
	): boolean {
