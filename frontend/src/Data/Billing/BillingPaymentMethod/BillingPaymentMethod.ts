...
export class BillingPaymentMethod {
	// RPC Methods
	public static RequestBillingPaymentMethodForCurrentSession = 
		RPCMethod.Register<RPCRequestBillingPaymentMethodForCurrentSession>(
			new RPCRequestBillingPaymentMethodForCurrentSession());
	public static PerformRegisterPaymentInformation = 
		RPCMethod.Register<RPCPerformRegisterPaymentInformation>(
			new RPCPerformRegisterPaymentInformation());

	public static GetMerged(mergeValues: Record<string, any>): IBillingPaymentMethod {
	...
	public static ValidateObject(o: IBillingPaymentMethod): IBillingPaymentMethod {
