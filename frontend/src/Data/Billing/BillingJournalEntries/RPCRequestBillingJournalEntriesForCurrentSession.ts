...
export type IRequestBillingJournalEntriesForCurrentSessionPayload = IIdempotencyRequest
	...
	export interface IRequestBillingJournalEntriesForCurrentSessionCB extends IIdempotencyResponse {
...
export class RPCRequestBillingJournalEntriesForCurrentSession extends RPCMethod {
	public Send(payload: IRequestBillingJournalEntriesForCurrentSessionPayload): IRoundTripRequest {
