...
export class BillingJournalEntries {
	// RPC Methods
	public static RequestBillingJournalEntriesForCurrentSession = RPCMethod.Register<
		RPCRequestBillingJournalEntriesForCurrentSession
	...
	public static PermBillingCanSetupPreAuthorizedCreditCardPayments(): boolean {
		...
		const ret =
			perms.indexOf(
				"billing.credit-card-payments.setup-pre-authorized"
			) !== -1;
		//console.log(perms, ret);
		return ret;
	}
