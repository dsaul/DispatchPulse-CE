...
export interface IRequestBillingCurrencyForCurrentSessionCB
...
export class RPCRequestBillingCurrencyForCurrentSession extends RPCMethod {
	public Send(
		payload: IRequestBillingCurrencyForCurrentSessionPayload
	): IRoundTripRequest {
	...
	public RecieveDefaultAction(
		...
		payload: IRequestBillingCurrencyForCurrentSessionCB
	): boolean {
