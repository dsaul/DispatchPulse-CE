...
export class BillingJournalEntriesType {
	// RPC Methods
	public static RequestBillingJournalEntriesTypeForCurrentSession = RPCMethod.Register<
		RPCRequestBillingJournalEntriesTypeForCurrentSession
	>(new RPCRequestBillingJournalEntriesTypeForCurrentSession());

	public static GetMerged(
		mergeValues: Record<string, any>
	): IBillingJournalEntriesType {
