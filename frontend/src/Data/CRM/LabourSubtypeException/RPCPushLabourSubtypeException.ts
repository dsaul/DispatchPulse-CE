...
export interface IPushLabourSubtypeExceptionPayload extends IIdempotencyRequest {
...
export class RPCPushLabourSubtypeException extends RPCMethod {
	public Send(payload: IPushLabourSubtypeExceptionPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IPushLabourSubtypeExceptionCB): boolean {
