...
export class SettingsDefault {
	// RPC Methods
	public static RequestSettingsDefault = RPCMethod.Register<
		RPCRequestSettingsDefault
	>(new RPCRequestSettingsDefault());
	public static DeleteSettingsDefault = RPCMethod.Register<
		RPCDeleteSettingsDefault
	>(new RPCDeleteSettingsDefault());
	public static PushSettingsDefault = RPCMethod.Register<
		RPCPushSettingsDefault
	>(new RPCPushSettingsDefault());
	...
	public static ForId(id: string | null): ISettingsDefault | null {
		...
		const statuses = store.state.Database.settingsDefault as Record<
			string,
			ISettingsDefault
		>;
