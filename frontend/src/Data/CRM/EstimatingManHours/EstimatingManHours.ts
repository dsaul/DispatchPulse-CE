...
export class EstimatingManHours {
	// RPC Methods
	public static RequestEstimatingManHours = 
		RPCMethod.Register<RPCRequestEstimatingManHours>(new RPCRequestEstimatingManHours());
	public static DeleteEstimatingManHours = 
		RPCMethod.Register<RPCDeleteEstimatingManHours>(new RPCDeleteEstimatingManHours());
	public static PushEstimatingManHours = RPCMethod.Register<RPCPushEstimatingManHours>(new RPCPushEstimatingManHours());
		...
		if (rtrNew.completeRequestPromise) {
			...
			rtrNew.completeRequestPromise.then(() => {
				if (ret._completeRequestPromiseResolve) {
					ret._completeRequestPromiseResolve(EstimatingManHours.ForId(id));
				}
			});
	...
	public static GetMerged(mergeValues: Record<string, any>): IEstimatingManHours {
	...
	public static ForId(id: string | null): IEstimatingManHours | null {
		...
		const statuses = store.state.Database.estimatingManHours as Record<string, IEstimatingManHours>;
	...
	public static UpdateIds(payload: Record<string, IEstimatingManHours>): void {
