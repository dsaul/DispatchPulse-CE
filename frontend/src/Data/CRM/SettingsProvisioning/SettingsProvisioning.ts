...
export class SettingsProvisioning {
	// RPC Methods
	public static RequestSettingsProvisioning = RPCMethod.Register<
		RPCRequestSettingsProvisioning
	>(new RPCRequestSettingsProvisioning());
	public static DeleteSettingsProvisioning = RPCMethod.Register<
		RPCDeleteSettingsProvisioning
	>(new RPCDeleteSettingsProvisioning());
	...
	public static ForId(id: string | null): ISettingsProvisioning | null {
		...
		const statuses = store.state.Database.settingsProvisioning as Record<
			string,
			ISettingsProvisioning
		>;
