...
export interface IRequestOnCallAutoAttendantsPayload extends IIdempotencyRequest {
...
export class RPCRequestOnCallAutoAttendants extends RPCMethod {
	public Send(payload: IRequestOnCallAutoAttendantsPayload): IRoundTripRequest {
	...
	public RecieveDefaultAction(rtr: IRoundTripRequest, payload: IRequestOnCallAutoAttendantsCB): boolean {
		...
		// Default action
		store.commit('UpdateOnCallAutoAttendantsRemote', payload.onCallAutoAttendants);
