...
export class OnCallAutoAttendant {
	// RPC Methods
	public static RequestOnCallAutoAttendants = RPCMethod.Register<
		RPCRequestOnCallAutoAttendants
	>(new RPCRequestOnCallAutoAttendants());
	public static DeleteOnCallAutoAttendants = RPCMethod.Register<
		RPCDeleteOnCallAutoAttendants
	>(new RPCDeleteOnCallAutoAttendants());
	public static PushOnCallAutoAttendants = RPCMethod.Register<
		RPCPushOnCallAutoAttendants
	>(new RPCPushOnCallAutoAttendants());
			...
			json: {
				...
				recordings: {
					intro: {
						type: "polly",
						text:
							"Thanks for calling, you've reached our after hours on call service.\n\n\n\n If you wish to leave a message for our on call representative, please press 1.",
						recordingId: null
					},
					askForCallbackNumber: {
						type: "polly",
						text:
							"Please provide a callback number that we can reach you at. Followed by the pound key.",
						recordingId: null
					},
					askForMessage: {
						type: "polly",
						text:
							"At the tone, leave a message detailing the nature of the request, as well as any other contact numbers.",
						recordingId: null
					},
					thankYouAfter: {
						type: "polly",
						text:
							"Thank you, we will dispatch this to the on call representative right away.",
						recordingId: null
					}
				},
	...
	public static ForId(id: string | null): IOnCallAutoAttendant | null {
		...
		const autoAttendants = store.state.Database.onCallAutoAttendants as {
			[id: string]: IOnCallAutoAttendant;
		};
	...
	public static UpdateIds(payload: {
		[id: string]: IOnCallAutoAttendant;
	}): void {
