...
export class LabourSubtypeNonBillable {
	// RPC Methods
	public static RequestLabourSubtypeNonBillable = 
		RPCMethod.Register<RPCRequestLabourSubtypeNonBillable>(new RPCRequestLabourSubtypeNonBillable());
	public static DeleteLabourSubtypeNonBillable = 
		RPCMethod.Register<RPCDeleteLabourSubtypeNonBillable>(new RPCDeleteLabourSubtypeNonBillable());
	public static PushLabourSubtypeNonBillable = 
		RPCMethod.Register<RPCPushLabourSubtypeNonBillable>(new RPCPushLabourSubtypeNonBillable());
		...
		if (rtrNew.completeRequestPromise) {
			...
			rtrNew.completeRequestPromise.then(() => {
				if (ret._completeRequestPromiseResolve) {
					ret._completeRequestPromiseResolve(LabourSubtypeNonBillable.ForId(id));
				}
			});
	...
	public static GetMerged(mergeValues: Record<string, any>): ILabourSubtypeNonBillable {
	...
	public static ForId(id: string | null): ILabourSubtypeNonBillable | null {
		...
		const types = store.state.Database.labourSubtypeNonBillable as Record<string, ILabourSubtypeNonBillable>;
	...
	public static UpdateIds(payload: Record<string, ILabourSubtypeNonBillable>): void {
	...
	public static All(): ILabourSubtypeNonBillable[] {
		...
		const dblist = store.state.Database.labourSubtypeNonBillable as Record<string, ILabourSubtypeNonBillable>;
	
		const filtered = _.filter(
			dblist,
			(o: ILabourSubtypeNonBillable) => {// eslint-disable-line @typescript-eslint/no-unused-vars
				return true;
			});
	...
	public static NameForId(id: string | null): string | null {
		...
		try {
			...
			const all = store.state.Database.labourSubtypeNonBillable as Record<string, ILabourSubtypeNonBillable>;
	...
	public static ValidateObject(o: ILabourSubtypeNonBillable): ILabourSubtypeNonBillable {
	...
	public static PermLabourSubtypeNonBillableCanPush(): boolean {
		...
		const ret = 
			...
			perms.indexOf('crm.labour-subtype-non-billable.push-company') !== -1;
	...
	public static PermLabourSubtypeNonBillableCanRequest(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.labour-subtype-non-billable.request-any') !== -1 ||
			perms.indexOf('crm.labour-subtype-non-billable.request-company') !== -1 ||
			perms.indexOf('crm.labour-subtype-non-billable.request-self') !== -1;
		//console.log(perms, ret);
		return ret;
	...
	public static PermLabourSubtypeNonBillableCanDelete(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.labour-subtype-non-billable.delete-any') !== -1 ||
			perms.indexOf('crm.labour-subtype-non-billable.delete-company') !== -1;
		//console.log(perms, ret);
		return ret;
	...
	public static PermCRMExportLabourSubtypeNonBillableCSV(): boolean {
		...
		const perms = BillingPermissionsBool.AllForBillingContactId();
		const ret = 
			perms.indexOf('crm.export.labour-non-billable-definitions-csv') !== -1;
		//console.log(perms, ret);
		return ret;
