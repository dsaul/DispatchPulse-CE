...
export class LabourSubtypeHoliday {
	// RPC Methods
	public static RequestLabourSubtypeHolidays = RPCMethod.Register<
		RPCRequestLabourSubtypeHolidays
	>(new RPCRequestLabourSubtypeHolidays());
	public static DeleteLabourSubtypeHolidays = RPCMethod.Register<
		RPCDeleteLabourSubtypeHolidays
	>(new RPCDeleteLabourSubtypeHolidays());
	public static PushLabourSubtypeHolidays = RPCMethod.Register<
		RPCPushLabourSubtypeHolidays
	>(new RPCPushLabourSubtypeHolidays());
	...
	public static ForId(id: string | null): ILabourSubtypeHoliday | null {
		...
		const types = store.state.Database.labourSubtypeHolidays as Record<
			string,
			ILabourSubtypeHoliday
		>;
	...
	public static All(): ILabourSubtypeHoliday[] {
		const dblist = store.state.Database.labourSubtypeHolidays as Record<
			string,
			ILabourSubtypeHoliday
		>;

		const filtered = _.filter(dblist, (o: ILabourSubtypeHoliday) => {
	...
	public static NameForId(id: string | null): string | null {
		try {
			...
			const all = store.state.Database.labourSubtypeHolidays as Record<
				string,
				ILabourSubtypeHoliday
			>;
	...
	public static PermLabourSubtypeHolidayCanRequest(): boolean {
		...
		const ret =
			...
			perms.indexOf("crm.labour-subtype-holidays.request-company") !==
				-1 ||
