...
export class DID {
	// RPC Methods
	public static RequestDIDs = RPCMethod.Register<RPCRequestDIDs>(new RPCRequestDIDs());
	public static DeleteDIDs = RPCMethod.Register<RPCDeleteDIDs>(new RPCDeleteDIDs());
	public static PushDIDs = RPCMethod.Register<RPCPushDIDs>(new RPCPushDIDs());
	public static PerformCheckDIDPBXRegistered = 
		RPCMethod.Register<RPCPerformCheckDIDPBXRegistered>(new RPCPerformCheckDIDPBXRegistered());
	public static PerformPBXDeRegisterDID = 
		RPCMethod.Register<RPCPerformPBXDeRegisterDID>(new RPCPerformPBXDeRegisterDID());
	public static PerformPBXRegisterDID = 
		RPCMethod.Register<RPCPerformPBXRegisterDID>(new RPCPerformPBXRegisterDID());
