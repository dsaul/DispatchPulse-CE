...
export class SettingsUser {
	// RPC Methods
	public static RequestSettingsUser = RPCMethod.Register<RPCRequestSettingsUser>(new RPCRequestSettingsUser());
	public static DeleteSettingsUser = RPCMethod.Register<RPCDeleteSettingsUser>(new RPCDeleteSettingsUser());
	public static PushSettingsUser = RPCMethod.Register<RPCPushSettingsUser>(new RPCPushSettingsUser());
	...
	public static ForId(id: string | null): ISettingsUser | null {
		...
		const statuses = store.state.Database.settingsUser as Record<string, ISettingsUser>;
