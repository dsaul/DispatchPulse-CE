...
export class Skill {
	// RPC Methods
	public static RequestSkills = RPCMethod.Register<RPCRequestSkills>(
		new RPCRequestSkills()
	);
	public static DeleteSkills = RPCMethod.Register<RPCDeleteSkills>(
		new RPCDeleteSkills()
	);
	public static PushSkills = RPCMethod.Register<RPCPushSkills>(
		new RPCPushSkills()
	);
