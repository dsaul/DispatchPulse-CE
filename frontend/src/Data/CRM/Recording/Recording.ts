...
export class Recording {
	// RPC Methods
	public static RequestRecordings = RPCMethod.Register<RPCRequestRecordings>(
		new RPCRequestRecordings()
	);
	public static DeleteRecordings = RPCMethod.Register<RPCDeleteRecordings>(
		new RPCDeleteRecordings()
	);
	public static PushRecordings = RPCMethod.Register<RPCPushRecordings>(
		new RPCPushRecordings()
	);
	...
	public static ForId(id: string | null): IRecording | null {
		...
		const statuses = store.state.Database.recordings as {
