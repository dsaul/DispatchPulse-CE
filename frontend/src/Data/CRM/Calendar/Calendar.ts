...
export class Calendar {
	// RPC Methods
	public static RequestCalendars = RPCMethod.Register<RPCRequestCalendars>(
		new RPCRequestCalendars()
	);
	public static DeleteCalendars = RPCMethod.Register<RPCDeleteCalendars>(
		new RPCDeleteCalendars()
	);
	public static PushCalendars = RPCMethod.Register<RPCPushCalendars>(
		new RPCPushCalendars()
	);
	public static PerformRetrieveCalendar = RPCMethod.Register<
		RPCPerformRetrieveCalendar
	>(new RPCPerformRetrieveCalendar());
	...
	public static ForId(id: string | null): ICalendar | null {
		...
		const cals = store.state.Database.calendars as {
			[id: string]: ICalendar;
		};
